...
public class basicRecords {
	public static void main (String [] args) {
		...
		double averages = (student1.average + student2.average + student3.average) / 3;

		System.out.println("The averages for the three students is: " + averages);
